...
class CreateConcoursParticipants extends BaseMigration
{
    public function change(): void
    {
        ...
        $table->addColumn('type_concours', 'string', [
            'default' => null,
            'limit' => 50,
            'null' => false,
        ]);
        ...
        $table->addForeignKey('category_id', 'concours_categories', 'id', ['delete' => 'RESTRICT', 'update' => 'RESTRICT']);
