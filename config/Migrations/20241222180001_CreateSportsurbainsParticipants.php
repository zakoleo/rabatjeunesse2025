...
class CreateSportsurbainsParticipants extends BaseMigration
{
    public function change(): void
    {
        ...
        $table->addForeignKey('category_id', 'sportsurbains_categories', 'id', ['delete' => 'RESTRICT', 'update' => 'RESTRICT']);
