...
class FixHandballTablesStructure extends BaseMigration
{
    /**
     * Up Method.
     *
    ...
    public function up(): void
    {
        ...
        $this->execute("
            CREATE TABLE handball_teams (
                ...
                type_handball ENUM('7x7', '5x5') NOT NULL,
                ...
                FOREIGN KEY (handball_district_id) REFERENCES football_districts(id) ON DELETE SET NULL,
                FOREIGN KEY (handball_organisation_id) REFERENCES football_organisations(id) ON DELETE SET NULL
        ...
        $this->execute("
            CREATE TABLE handball_teams_joueurs (
                ...
                FOREIGN KEY (handball_team_id) REFERENCES handball_teams(id) ON DELETE CASCADE
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
        ");
    }
