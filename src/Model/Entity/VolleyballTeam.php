...
/**
 * VolleyballTeam Entity
 *
 * @property int $id
 * @property string $nom_equipe
 * @property string $categorie
 * @property string $genre
 * @property string $type_volleyball
 ...
 * @property int|null $volleyball_category_id
 * @property int|null $volleyball_district_id
 * @property int|null $volleyball_organisation_id
 ...
 * @property \App\Model\Entity\VolleyballTeamsJoueur[] $volleyball_teams_joueurs
 */
class VolleyballTeam extends Entity
{
    /**
    ...
    protected array $_accessible = [
        ...
        'volleyball_category_id' => true,
        'volleyball_district_id' => true,
        'volleyball_organisation_id' => true,
