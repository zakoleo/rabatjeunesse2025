 ...
 * @property int|null $handball_category_id
 * @property int|null $handball_district_id
 * @property int|null $handball_organisation_id
 ...
 * @property \App\Model\Entity\HandballTeamsJoueur[] $handball_teams_joueurs
 */
class HandballTeam extends Entity
{
    /**
    ...
    protected array $_accessible = [
        ...
        'handball_district_id' => true,
        'handball_organisation_id' => true,
