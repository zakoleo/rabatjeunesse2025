...
/**
 * BasketballTeam Entity
 *
 * @property int $id
 * @property string $nom_equipe
 * @property string $categorie
 * @property string $genre
 * @property string $type_basketball
 ...
 * @property int|null $basketball_category_id
 * @property int|null $basketball_district_id
 * @property int|null $basketball_organisation_id
 ...
 * @property \App\Model\Entity\BasketballTeamsJoueur[] $basketball_teams_joueurs
 */
class BasketballTeam extends Entity
{
    /**
    ...
    protected array $_accessible = [
        ...
        'basketball_district_id' => true,
        'basketball_organisation_id' => true,
