...
class TeamsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->maxLength('type_football', 10, 'Le type de football ne peut pas dépasser 10 caractères.')
            ->requirePresence('type_football', 'create', 'Le type de football est requis.')
            ->notEmptyString('type_football', 'Le type de football ne peut pas être vide.')
            ->inList('type_football', ['5x5', '6x6', '11x11'], 'Le type de football doit être "5x5", "6x6" ou "11x11".');
