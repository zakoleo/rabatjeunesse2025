...
class ConcoursParticipantsTable extends Table
{
    public function initialize(array $config): void
    {
        parent::initialize($config);

        $this->setTable('concours_participants');
        ...
        $this->belongsTo('ConcoursCategories', [
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('type_concours')
            ->inList('type_concours', ['Dessin', 'Chanson', 'Commentateur sportifs', 'Film documentaire'])
            ->requirePresence('type_concours', 'create')
            ->notEmptyString('type_concours');
    ...
    public function buildRules(RulesChecker $rules): RulesChecker
    {
        ...
        $rules->add($rules->existsIn(['category_id'], 'ConcoursCategories'), ['errorField' => 'category_id']);
        ...
        $rules->add(function ($entity, $options) {
            ...
            $category = $this->ConcoursCategories->get($entity->category_id);
    ...
    // Get concours types
    public static function getConcoursTypes()
    {
        return [
            'Dessin' => 'Dessin',
            'Chanson' => 'Chanson',
            'Commentateur sportifs' => 'Commentateur sportifs',
