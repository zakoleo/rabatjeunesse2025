...
class CrosstrainingParticipantsTable extends Table
{
    public function initialize(array $config): void
    {
        parent::initialize($config);

        $this->setTable('crosstraining_participants');
        ...
        $this->belongsTo('CrosstrainingCategories', [
    ...
    public function buildRules(RulesChecker $rules): RulesChecker
    {
        ...
        $rules->add($rules->existsIn(['category_id'], 'CrosstrainingCategories'), ['errorField' => 'category_id']);
        ...
        $rules->add(function ($entity, $options) {
            ...
            $category = $this->CrosstrainingCategories->get($entity->category_id);
