 ...
 */
?>
<div class="volleyball-relationships content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>🔗 Volleyball Relations</h2>
        <?= $this->Html->link('🏐 Dashboard', ['action' => 'index'], ['class' => 'btn btn-outline-secondary']) ?>
    </div>
    
    <div class="card shadow">
        <div class="card-header"><h6 class="m-0 font-weight-bold text-success">Relations Catégories ↔ Types Volleyball</h6></div>
        <div class="card-body">
