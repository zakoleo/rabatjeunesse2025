 ...
 * @var \App\Model\Entity\SportsurbainsParticipant[] $participants
 */
?>
<div class="sportsurbains-participants index">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="mb-0">Mes inscriptions Sports Urbains</h3>
                    ...
                    <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $participant->has('sportsurbains_category') ? h($participant->sportsurbains_category->name) : '' ?></td>
                        ...
                        <?php else: ?>
                            <div class="alert alert-info">
                                ...
                                <p>Vous n'avez pas encore d'inscription aux Sports Urbains.</p>
                                <hr>
                                <p class="mb-0">
