 ...
 */
?>
<div class="sportsurbains-participants view">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="mb-0">Détails de l'inscription Sports Urbains</h3>
                            <div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>Type de sport</th>
                                        <td><span class="badge badge-info"><?= h($participant->type_sport) ?></span></td>
                                    </tr>
                                    <tr>
                                        <th>Nom complet</th>
