...
<div class="teams form container">
    <div class="inscription-header">
        <h1>Inscription Sports Urbains</h1>
        <p class="subtitle">Les Sports Urbains sont un sport individuel. Complétez le formulaire ci-dessous pour vous inscrire.</p>
    </div>
    ...
    <div class="wizard-container">
        <section class="form-section">
            ...
            <div class="form-group">
                <?= $this->Form->control('type_sport', [
                    'label' => 'Type de sport urbain *',
                    'options' => $sportTypes,
                    'empty' => 'Sélectionner un sport...',
                    'required' => true,
                    'class' => 'form-control'
                ]) ?>
            </div>
