 ...
 */
?>
<div class="crosstraining-participants view">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="mb-0">Détails de l'inscription Cross Training</h3>
                            <div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        <th>Photo</th>
                                        <td><?= $participant->photo ? 'Téléchargé' : 'Non fourni' ?></td>
                                    </tr>
                                    <tr>
                                        <th>CIN Recto</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $participant->certificat_medical ? 'Téléchargé' : 'Non fourni' ?></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
