 ...
 * @var \App\Model\Entity\CrosstrainingParticipant[] $participants
 */
?>
<div class="crosstraining-participants index">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="mb-0">Mes inscriptions Cross Training</h3>
                    ...
                    <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $participant->has('crosstraining_category') ? h($participant->crosstraining_category->name) : '' ?></td>
                        ...
                        <?php else: ?>
                            <div class="alert alert-info">
                                ...
                                <p>Vous n'avez pas encore d'inscription au Cross Training.</p>
                                <hr>
                                <p class="mb-0">
