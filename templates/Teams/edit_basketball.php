...
$this->assign('title', 'Modifier l\'équipe de Basketball');
?>
<div class="teams form container">
    <div class="inscription-header">
        <h1>Modifier l'équipe de Basketball</h1>
        <p class="subtitle">Mettez à jour les informations de votre équipe</p>
    </div>

    <?= $this->Form->create($team, ['type' => 'file', 'id' => 'editBasketballForm']) ?>
    ...
    <div class="actions mt-3">
        <?= $this->Html->link('Annuler', ['action' => 'basketballTeamView', $team->id], ['class' => 'btn btn-secondary']) ?>
...
<?= $this->Html->script('basketball-inscription-form') ?>
