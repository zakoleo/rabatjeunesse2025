 ...
 * @var \App\Model\Entity\BeachvolleyTeam $team
 */

$this->assign('title', 'Équipe de Beach Volleyball - ' . h($team->nom_equipe));
?>

<div class="beachvolley-team-view container">
    <div class="team-header">
        <h1><?= h($team->nom_equipe) ?></h1>
        <div class="team-badges">
            <span class="badge badge-sport">Beach Volleyball</span>
    ...
    <div class="team-content">
        <div class="team-info-grid">
            ...
            <div class="info-card">
                ...
                <div class="info-row">
                    <span class="label">Type de beach volleyball:</span>
                    <span class="value"><?= h($team->type_beachvolley ?? 'N/A') ?></span>
                </div>
                <div class="info-row">
        ...
        <div class="players-section">
            <h3><i class="fas fa-users"></i> Liste des joueurs (<?= count($team->beachvolley_teams_joueurs ?? []) ?>)</h3>
            
            <?php if (!empty($team->beachvolley_teams_joueurs)): ?>
            <div class="players-grid">
                <?php foreach ($team->beachvolley_teams_joueurs as $index => $joueur): ?>
    ...
    <div class="team-actions">
        ...
        <?= $this->Html->link(
            ...
            ['controller' => 'Teams', 'action' => 'downloadBeachvolleyPdf', $team->id],
            ['class' => 'btn btn-success', 'escape' => false]
        ) ?>
    </div>
</div>
