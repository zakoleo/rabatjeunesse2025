...
<div class="beachvolley-categories content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>📋 Beach Volleyball Categories</h2>
        <?= $this->Html->link('🏖️ Dashboard', ['action' => 'index'], ['class' => 'btn btn-outline-secondary']) ?>
    </div>
    
    <div class="card shadow">
        <div class="card-header"><h6 class="m-0 font-weight-bold text-primary">Catégories Beach Volleyball</h6></div>
        <div class="card-body">
            ...
            <?php else: ?>
                <p class="text-center text-muted">Aucune catégorie beach volleyball configurée</p>
            <?php endif; ?>
        </div>
    </div>
</div>