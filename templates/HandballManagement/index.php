 ...
 */
?>
<div class="handball-management-dashboard content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1">🤾 Handball Dashboard</h2>
            ...
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <?php
                        try {
                            $teamsTable = \Cake\ORM\TableRegistry::getTableLocator()->get('HandballTeams');
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card shadow">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold text-primary">🤾 Catégories Handball</h6>
                </div>
                <div class="card-body">
                    <?php if (!empty($categories)): ?>
                        <?php foreach (array_slice($categories, 0, 5) as $category): ?>
                            <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                                ...
                                <small><?= count($category->handball_types ?? []) ?> types</small>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
        ...
        <div class="col-lg-6">
            <div class="card shadow">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold text-info">🏟️ Types Handball</h6>
                </div>
                <div class="card-body">
                    <?php if (!empty($types)): ?>
