 ...
 */
?>
<div class="handball-categories content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>📋 Handball Categories</h2>
        <?= $this->Html->link('🤾 Dashboard', ['action' => 'index'], ['class' => 'btn btn-outline-secondary']) ?>
    </div>
    
    <div class="card shadow">
        <div class="card-header"><h6 class="m-0 font-weight-bold text-primary">Catégories Handball</h6></div>
        <div class="card-body">
                    ...
                    <tbody>
                        <?php foreach ($categories as $category): ?>
                            <tr>
                                ...
                                <td><span class="badge badge-light"><?= count($category->handball_types ?? []) ?> types</span></td>
            ...
            <?php else: ?>
                <p class="text-center text-muted">Aucune catégorie handball configurée</p>
            <?php endif; ?>
        </div>
    </div>
</div>